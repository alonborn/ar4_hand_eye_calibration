...
class ArucoPoseVisualizer(Node):
    ...
    def __init__(self):
        ...
        self.image_sub = self.create_subscription(
            Image, '/ov5640/image_raw', self.image_callback, 10)

        self.camera_info_sub = self.create_subscription(
            CameraInfo, '/ov5640/camera_info', self.camera_info_callback, 10)

        self.markers_sub = self.create_subscription(
            ArucoMarkers, '/aruco_markers', self.aruco_markers_callback, 10)
    ...
    def image_callback(self, msg):
        ...
        # Publish overlay image and camera info
        try:
